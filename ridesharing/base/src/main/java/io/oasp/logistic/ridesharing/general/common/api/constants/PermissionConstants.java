...
public abstract class PermissionConstants {
    ...
    /**
     * {@link io.oasp.module.security.common.api.accesscontrol.AccessControlPermission} to retrieve user profile.
     */
    public static final String FIND_USER_PROFILE = "FindUserProfile";

    /**
     * {@link io.oasp.module.security.common.api.accesscontrol.AccessControlPermission} to save user profile.
     */
    public static final String SAVE_USER_PROFILE = "SaveUserProfile";

    /**
     * {@link io.oasp.module.security.common.api.accesscontrol.AccessControlPermission} to remove user profile.
     */
