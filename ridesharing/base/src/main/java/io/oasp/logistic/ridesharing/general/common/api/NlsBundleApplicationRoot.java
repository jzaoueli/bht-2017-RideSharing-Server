...
public interface NlsBundleApplicationRoot extends NlsBundle {
  ...
  /**
   * @see io.oasp.logistic.ridesharing.general.common.api.exception.IllegalEntityStateException
   *
  ...
  /**
   * @see io.oasp.logistic.ridesharing.general.common.api.exception.NoActiveUserException
   *
   * @return the {@link NlsMessage}.
   */
  ...
  /**
   * @see io.oasp.logistic.ridesharing.offermanagement.common.api.exception.OfferEmptyException
   *
   * @return the {@link NlsMessage}.
   */
  ...
  /**
   * @see io.oasp.logistic.ridesharing.salesmanagement.common.api.exception.ChangeTableIllegalStateCombinationException
   *
